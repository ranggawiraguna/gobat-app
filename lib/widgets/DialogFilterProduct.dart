...
class DialogFilterProduct extends StatefulWidget {
  ...
  @override
  _DialogFilterArticProductState createState() =>
      _DialogFilterArticProductState();
}

class _DialogFilterArticProductState extends State<DialogFilterProduct> {
